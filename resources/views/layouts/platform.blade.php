    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="index.html">i<span>Cheapbooks</span></a></h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; {{date('Y').' '.env('APP_NAME')}}. All Rights Reserved. Designed by <a href="http://design-by-verdi.com" target="_blank">Verdi Co.</a></p>
                    </div>
                </div>
